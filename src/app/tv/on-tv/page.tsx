  ...
  return (
    <div className="min-h-screen text-black flex flex-col items-center justify-center">
      ...
      <div className="flex items-center justify-center">
        <Link
          href={"/"}
          className="px-4 py-2 text-black font-semibold bg-yellow-500 rounded-lg shadow-lg hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500"
        >
          Back to Home
        </Link>
      </div>
